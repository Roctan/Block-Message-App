...
const CONTRACT_ADDRESS = "0x11B606dfd68965eeFBF9bDEf628BC73D4985560A";
...
export function App(props) {
    ...
    async function login() {
        ...
        if (res === true) {
            ...
            try {
                ...
                let present = await contract.checkUser(address);
    ...
    async function addChat(name, publicKey) {
        try {
            let present = await myContract.checkUser(publicKey);
            if (!present) {
